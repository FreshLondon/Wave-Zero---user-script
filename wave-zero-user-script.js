// ==UserScript==
// @name         Wave Zero - user script
// @namespace    https://thcalliance.us
// @version      1.1
// @description	 User script for Wave Zero members.
// @author       You
// @match        https://*.planetarion.com/*
// @updateURL    https://planetarion.freshlondon.biz/js/wave-zero-user-script.js
// @downloadURL  https://planetarion.freshlondon.biz/js/wave-zero-user-script.js
// @grant        none
// ==/UserScript==
	...
	(function (w) {
		...
		function menu_updateMenu() {
			...
			$j('#menu_alliance').append('<ul>' +
				...
				'<li><a href="https://thcalliance.us/att" target="_blank">Attacks</a></li>' +
